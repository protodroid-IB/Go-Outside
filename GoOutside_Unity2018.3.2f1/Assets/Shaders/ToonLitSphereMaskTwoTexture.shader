...
uniform float3 GLOBALMASK_Position1; // from script
uniform float GLOBALMASK_Radius1;
...
void surf (Input IN, inout SurfaceOutput o) {
    ...
    float3 dis = distance(GLOBALMASK_Position1, IN.worldPos);
    float3 sphere = 1 - saturate(dis / GLOBALMASK_Radius1);
